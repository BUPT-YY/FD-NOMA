...
semilogy(PBSdbm, result0,'x-',PBSdbm, result1,'o-',PBSdbm, result2,'+-',PBSdbm, result3,'s-',PBSdbm, result4,'d-',PBSdbm, result5,'*-','MarkerIndices',linspace(1,npoints,5));
legend('Upper bound, M=2','Upper bound, M=3','M = 2, r_{1} = 10, r_2 = 0','M = 3, r_{1} = 10, r_2 = 0','M = 2, r_{1} = 15, r_2 = 5','M = 3, r_{1} = 15, r_2 = 5')
